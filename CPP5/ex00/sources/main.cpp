...
int	main(void)
{
	...
	std::cout << std::endl << "--Good Increase--" << std::endl;
	try {
	...
	std::cout << std::endl << "--Bad Increase--" << std::endl;
	try {
	...
	std::cout << std::endl << "--Good Decrease--" << std::endl;
	try {
	...
	std::cout << std::endl << "--Bad Decrease--" << std::endl;
	try {
